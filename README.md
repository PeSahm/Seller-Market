...
[![Locust](https://img.shields.io/badge/locust-2.0+-green.svg)](https://locust.io/)[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

[![Locust](https://img.shields.io/badge/locust-2.0+-green.svg)](https://locust.io/)

> Automated trading bot for Iranian stock exchanges (ephoenix.ir platforms) with Telegram control, intelligent caching, and Windows service support.
...
### Manual Execution- ✅ **Shahr** - identity-shahr.ephoenix.ir

| Command | Description |- 🔄 **Karamad, Tejarat, Shams** - Configurable

|---------|-------------|

| `/cache` | Run cache warmup now |### Intelligent Caching System

| `/trade` | Start trading bot now |

| `/status` | Show system status |- � **Token Cache** - 1 hour expiry, auto-refresh

- 📊 **Market Data Cache** - 5 minute expiry for price/volume limits

### Scheduler Management- 💰 **Buying Power Cache** - 1 minute expiry
